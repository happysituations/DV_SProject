...
####This link is to the shortened version, so that there is a lesser chance of connection errors
https://jennawebb117.shinyapps.io/Project6  

####This link is to the full version, which takes a long time to load  
https://happysituations.shinyapps.io/project6shinyapp  

If the application does not load, here are the screenshots of the full version:  
![](../02 Shiny/crosstab.png)  
![](../02 Shiny/chl.png)  
![](../02 Shiny/gonandcam.png)  
![](../02 Shiny/scatterall.png)  
![](../02 Shiny/mf.png)  
