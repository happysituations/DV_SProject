...
The shiny application takes a couple of minutes to load due to many the many dataframes being used, and the large dataset we chose to use. For the barchart, the top three diseases have been chosen to reduce the amount of time it takes to load.  
